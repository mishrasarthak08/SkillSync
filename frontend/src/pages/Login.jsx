        ...
        <div className="flex flex-col md:flex-row flex-1">
          ...
          <div className="w-full lg:w-2/5 flex flex-col justify-center items-center p-8 sm:p-12 bg-white dark:bg-black transition-colors duration-300">
            <div className="w-full max-w-md">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-8 text-lg">Enter your credentials to access your account.</p>
              ...
              <p className="text-center text-gray-600 dark:text-gray-400">
                ...
                <Link className="font-bold text-primary dark:text-primary hover:underline transition-all duration-200" to="/signup">
                  Sign Up
                </Link>
              </p>
            </div>
